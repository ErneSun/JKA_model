...
- run: `v05-final-20260814-physics-seed53`
- commit: `976de084c540e28a21411614ed0c854291ed491c`; dirty: `False`
- GPU / precision: `NVIDIA GeForce RTX 5080` / `fp32`
- checkpoint / selection epoch: `best_forecast_post_warmup` / 149
- selection rule: minimum validation forecast MSE after physics warmup
- long model / persistence RMSE: 0.0128778 / 0.925666
- frequency / decay relative error: 0.00235921 / 0.15161
- frequency hard gate: **PASS** (threshold 0.05)
- decay hard gate: **PASS** (threshold 0.2)
- stability hard gate: **PASS**; spectral abscissa -2.33549e-05
...
- long mass drift / operator: 0.000685681 / 1.92288e-07
- peak VRAM bytes / max samples s^-1: 2907331072 / 157.313
