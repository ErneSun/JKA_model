...
- run: `v05-final-20260813-physics-seed47`
- commit: `7695a9366ecc55a35df380666a8a4b729408185e`; dirty: `False`
- GPU / precision: `NVIDIA GeForce RTX 5080` / `fp32`
- checkpoint / selection epoch: `best_forecast_post_warmup` / 140
- selection rule: minimum validation forecast MSE after physics warmup
- long model / persistence RMSE: 0.0148459 / 1.03311
- frequency / decay relative error: 0.00235256 / 0.155932
- frequency hard gate: **PASS** (threshold 0.05)
- decay hard gate: **PASS** (threshold 0.2)
- stability hard gate: **PASS**; spectral abscissa -8.24385e-05
- beats persistence by horizon: {'short': True, 'medium': True, 'long': True}
- long mass drift / operator: 0.000612039 / 0.000170197
- peak VRAM bytes / max samples s^-1: 2907331072 / 148.713
