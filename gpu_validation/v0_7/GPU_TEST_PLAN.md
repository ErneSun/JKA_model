...
6. Record validation residual magnitude as a non-gating diagnostic, compute Markovian predictability and conditional history gain, and lock preliminary R1/R2/R3/INCONCLUSIVE routing without test selection.
