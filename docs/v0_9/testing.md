...
冻结 decoder 物理梯度、旧 checkpoint 兼容、condition visibility、residual decomposition、teacher-free rollout、
smooth/abrupt schedules、严格 handoff、nested aggregation、run-ID 与 completion contract。
