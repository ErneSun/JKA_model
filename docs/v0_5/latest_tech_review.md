...
| Physics-informed operator residual | ADOPT | raw-unit mass + discrete operator consistency | PINO 等工作支持数据与 PDE constraint 联合训练；本版只采用便宜、可验证的 finite-difference constraint |
