...
Residual magnitude remains supporting evidence and never terminates the route. Memory class also remains supporting evidence and no longer directly chooses the architecture family. The generated recommendation is evidence-dependent and never treats software success as scientific support. V0.7 implements none of `c_t`, `eta_t`, adaptive `A_t`, or V0.8 training.
